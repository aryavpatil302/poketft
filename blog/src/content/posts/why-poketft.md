---
title: "Why PokeFight"
description: "TFT and Pokemon are two of my favorite games, so naturally I combined them both"
date: 2026-04-26
---
...
![Early sorting board of Pokemon candidates grouped into AP damage, AD damage, tanks, and misc buckets](./why-poketft/ideation.png)
*Every Pokemon I was considering, sorted into rough combat roles: the actual first pass at turning the daydream into something concrete.*
...
![Live PokeFight match in progress, showing the hex board mid-fight, trait panel, shop, and bot lobby](./why-poketft/final-result.png)
*Where that sorting board ended up: a real match against real bots, shop and all.*
